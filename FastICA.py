...
def _sym_decorrelation(W):
    ...
    U, _, Vt = scipy.linalg.svd(W, full_matrices=False, overwrite_a=True, check_finite=False)
    return U.dot(Vt)
...
def fastica(X, n_components=None, algorithm="parallel", whiten=True,
    ...
    if whiten:
        ...
        u, d, _ = scipy.linalg.svd(X, full_matrices=False, overwrite_a=True, check_finite=False)
